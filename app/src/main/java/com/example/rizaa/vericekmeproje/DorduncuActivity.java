...
public class DorduncuActivity extends AppCompatActivity {
    ...
    private static  String URL="http://www.ozturkriza.com/home/iletisim";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dorduncu_activity);
    ...
    private class VeriGetir extends AsyncTask<Void,Void,Void> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog= new ProgressDialog(DorduncuActivity.this);
        ...
        protected Void doInBackground(Void... voids) {try {
            ...
            Elements veri=gelen.select("div [class=\"well well-small\"]");
